package lzw.learn_usual_module;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_men.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                sex.setText(""+sex.getText()+button_men.getText());
                Toast.makeText(MainActivity.this,"you are men",Toast.LENGTH_SHORT).show();
            }
        });
...
或改为getText().toString()+box_women.getText()
*/